...
const RecipeCard = ({ href, title, category }: RecipeCardType) => (
  <Link
    href={href}
    className="flex flex-row items-center justify-between rounded-xl bg-zinc-100 py-2 px-3 outline-none hover:bg-primary-100 hover:text-primary-700 focus:bg-primary-100 focus:text-primary-700 dark:bg-zinc-700 dark:hover:bg-primary-300 dark:focus:bg-primary-300 sm:p-4"
  >
    <>
